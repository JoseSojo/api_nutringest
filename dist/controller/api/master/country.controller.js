...
let CountryController = class CountryController {
    constructor(service, permit, appEvents, history, languaje) {
    ...
    async update(req, body, param) {
        ...
        if (body.prefixPhone)
            data.prefixPhone = body.prefixPhone;
...
], CountryController.prototype, "paginate", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], CountryController.prototype, "unique", null);
__decorate([
