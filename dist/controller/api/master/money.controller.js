...
let MoneyController = class MoneyController {
    ...
    async create(req, body) {
        ...
        await this.history.create({
            ...
            eventName: this.appEvents.EVENT_CONFIG_MONEY_CREATE,
    ...
    async update(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_CONFIG_MONEY_UPDATE,
            objectName: this.objectName(),
    ...
    async delete(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_CONFIG_MONEY_DELETE,
            objectName: this.objectName(),
            objectReferenceId: param.id
        });
        const response = await responsePromise;
...
], MoneyController.prototype, "paginate", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], MoneyController.prototype, "unique", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], MoneyController.prototype, "delete", null);
MoneyController = __decorate([
    (0, common_1.Controller)(`money`),
    __metadata("design:paramtypes", [money_service_1.default,
        AppEvent_1.default,
