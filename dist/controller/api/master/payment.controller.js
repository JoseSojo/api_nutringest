...
let PaymentMethodController = class PaymentMethodController {
    ...
    async create(req, body) {
        ...
        const data = {
            ...
            moneyReference: { connect: { id: body.moneyId } }
        };
        const responsePromise = this.service.create({ data });
        const response = await responsePromise;
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_CONFIG_PAYMENT_METHOD_CREATE,
    ...
    async update(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_CONFIG_PAYMENT_METHOD_UPDATE,
            objectName: this.objectName(),
    ...
    async delete(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_CONFIG_PAYMENT_METHOD_DELETE,
            objectName: this.objectName(),
            objectReferenceId: param.id
        });
        const response = await responsePromise;
...
__decorate([
    (0, common_1.Get)(`:id/unique/public`),
    (0, common_1.UseGuards)(AuthGuard_1.AuthGuard),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentMethodController.prototype, "uniquePublic", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentMethodController.prototype, "unique", null);
__decorate([
