...
let SubscriptionController = class SubscriptionController {
    ...
    async detailDelete(req, param, body) {
        const user = req.user;
        const permit = user.rolReference.roles;
    ...
    async update(req, body, param) {
        ...
        if (body.countMonth)
            data.countMonth = body.countMonth;
        if (body.defaultMount)
            data.defaultMount = body.defaultMount;
    ...
    objectName() { return `subscription`; }
};
__decorate([
...
], SubscriptionController.prototype, "paginatePublic", null);
__decorate([
    (0, common_1.Get)(``),
    ...
    __metadata("design:returntype", Promise)
], SubscriptionController.prototype, "paginate", null);
__decorate([
    (0, common_1.Get)(`/detail/:id/unique`),
    (0, common_1.UseGuards)(AuthGuard_1.AuthGuard),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SubscriptionController.prototype, "detailUnique", null);
__decorate([
    (0, common_1.Put)(`/detail/:id/delete`),
    (0, common_1.UseGuards)(AuthGuard_1.AuthGuard),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)()),
    ...
    __metadata("design:returntype", Promise)
], SubscriptionController.prototype, "detailDelete", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SubscriptionController.prototype, "unique", null);
__decorate([
...
SubscriptionController = __decorate([
    ...
    __metadata("design:paramtypes", [subsccription_service_1.default,
        AppEvent_1.default,
