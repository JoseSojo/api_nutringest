...
let SupplementController = class SupplementController {
    ...
    async create(req, body) {
        ...
        await this.history.create({
            ...
            eventName: this.appEvents.EVENT_NUTRI_SUPPLEMENT_CREATE,
    ...
    async update(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_NUTRI_SUPPLEMENT_UPDATE,
            objectName: this.objectName(),
    ...
    async delete(req, body, param) {
        ...
        await this.history.create({
            userReference: { connect: { id: user.id } },
            eventName: this.appEvents.EVENT_NUTRI_SUPPLEMENT_DELETE,
            objectName: this.objectName(),
            objectReferenceId: param.id
        });
        const response = await responsePromise;
...
], SupplementController.prototype, "paginate", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SupplementController.prototype, "unique", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SupplementController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SupplementController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], SupplementController.prototype, "delete", null);
SupplementController = __decorate([
    (0, common_1.Controller)(`supplement`),
    __metadata("design:paramtypes", [supplement_service_1.default,
        AppEvent_1.default,
        history_service_1.default,
        AppActions_1.default,
        languaje_service_1.LanguajeService])
], SupplementController);
exports.default = SupplementController;
//# sourceMappingURL=supplement.controller.js.map