...
export default class CityController {
    ...
    constructor(
        private service: ConfigCityService,
    ...
    private async unique(@Req() req: any, @Param() param: { id: string }) {
        ...
        // validar eliminación
        const filter: Prisma.ConfigCityWhereInput = { id:param.id };
    ...
    private async create(@Req() req: any, @Body() body: any) {
        ...
        await this.history.create({ 
            ...
            eventName:this.appEvents.EVENT_CONFIG_CITY_CREATE,
    ...
    private async update(@Req() req: any, @Body() body: any, @Param() param: { id: string }) {
        ...
        const data: Prisma.ConfigCityUpdateInput = {
            name: body.name
        }
    ...
    private objectName() { return `city` }
