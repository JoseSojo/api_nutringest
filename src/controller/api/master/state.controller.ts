...
export default class StateController {
    ...
    constructor(
        private service: ConfigStateService,
    ...
    private async unique(@Req() req: any, @Param() param: { id: string }) {
        ...
        // validar eliminación
        const filter: Prisma.ConfigStateWhereInput = { id:param.id };
    ...
    private async create(@Req() req: any, @Body() body: any) {
        ...
        await this.history.create({ 
            ...
            eventName:this.appEvents.EVENT_CONFIG_STATE_CREATE,
    ...
    private async update(@Req() req: any, @Body() body: any, @Param() param: { id: string }) {
        ...
        const data: Prisma.ConfigStateUpdateInput = {
            name: body.name,
        }
        ...
        await this.history.create({ 
            // userId:user.id,
            userReference:{connect:{id:user.id}},
            eventName:this.appEvents.EVENT_CONFIG_STATE_UPDATE,
            objectName:this.objectName(), 
    ...
    private async delete(@Req() req: any, @Body() body: any, @Param() param: { id: string }) {
        ...
        await this.history.create({ 
            // userId:user.id,
            userReference:{connect:{id:user.id}},
            eventName:this.appEvents.EVENT_CONFIG_STATE_DELETE,
            objectName:this.objectName(), 
            objectReferenceId: param.id
        });
    ...
    private objectName() { return `state` }
