...
export default class SupplementController {
    ...
    constructor(
        private service: SupplementService,
    ...
    private async unique(@Req() req: any, @Param() param: { id: string }) {
        ...
        // validar eliminación
        const filter: Prisma.SupplementWhereInput = { id:param.id };
    ...
    private async create(@Req() req: any, @Body() body: any) {
        ...
        const data: Prisma.SupplementCreateInput = {
    ...
    private objectName() { return `supplement` }
}
