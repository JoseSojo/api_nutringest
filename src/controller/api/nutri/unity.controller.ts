...
export default class UnityMeasureController {
    ...
    constructor(
        private service: UnityMeasureService,
    ...
    private async unique(@Req() req: any, @Param() param: { id: string }) {
        ...
        // validar eliminación
        const filter: Prisma.UnityMeasureWhereInput = { id:param.id };
    ...
    private async create(@Req() req: any, @Body() body: any) {
        ...
        const data: Prisma.UnityMeasureCreateInput = {
            name: body.name,
    ...
    private async update(@Req() req: any, @Body() body: any, @Param() param: { id: string }) {
        ...
        const data: Prisma.UnityMeasureUpdateInput = {
            name: body.name,
            abr: body.abr
        }
